...
Per-integration health state is also exposed individually, enabling the dashboard to display a detailed integration status panel with health score, error rate, and last heartbeat for each integration.
