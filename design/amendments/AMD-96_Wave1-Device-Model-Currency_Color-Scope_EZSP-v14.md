...
status: PROPOSED 2026-06-26 (v7 hub). NOT self-ratified. Direction RATIFIED via the §3 consolidated decision pass (B4 color scope = White/CT; B5 EZSP-v14 currency); this amendment carries the precise Doc 02/08 edits for a source-verifying currency review → Nick co-sign → fold (the AMD-95 pattern). At ratification the watermark advances AMD-95 → AMD-96.
