...
The on-disk inventory in `design/amendments/` contains numbered amendments AMD-25 through AMD-64 plus **AMD-86** and **AMD-87** (M5 window) plus the non-numbered `AMD-M2Bridge_Tier2_Schema_Reservations.md`. AMD-01..AMD-24, AMD-28..AMD-30, AMD-46, AMD-48, AMD-49 are intentionally non-existent or reserved-unused (the numbering is not contiguous — early decisions were resolved without going to amendment; the M4 device/projection blocks 44–52 are allocated under the P2 scheme; AMD-53 is the timestamp-model unifier; AMD-54..64 are the Workstream C integration block, assigned contiguously at the 2026-06-05 briefing per the P2 assign-at-milestone rule and ratified as a block the same day). **AMD-86** (INV-PD-07 crypto-shred MVP-scope narrow + INV-PD-03 at-rest posture; owner doc Doc 15) and **AMD-87** (`Expectation` persisted codec, reassigned from the retired AMD-65 per the P2 renumbering ledger) were ratified 2026-06-07 in the M5 window; AMD-65 is retired, AMD-66–71 reserved for the M6 config block, AMD-72–85 reserved for Research 7 (REST/WS, M10/M11). **On-disk amendment watermark: AMD-87 (raised from AMD-64 on 2026-06-07 at the M5-window crypto + codec ratification — AMD-86 + Doc 15 Lock + AMD-87).**
