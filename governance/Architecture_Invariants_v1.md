...
**Total: 172 invariants across 51 identifier categories (§0.3).** _Regenerated from this table at the 2026-07-01 consolidated governance pass (v13 hub): **+INV-ES-09** (§2 — pure-function replay, D2's canonical id; a watermark-NEUTRAL doc-currency registration per the decision-record's own authorization + the SA/AC precedent) and **+AMD-97-INV-01** (§51 — never-false-CONFIRMED, minted at the AMD-97 ratification; +1 category `AMD-97-INV`); **the on-disk amendment watermark advanced AMD-95 → AMD-96 → AMD-97 in the same pass** (AMD-96 Wave-1 device-model currency [consolidated: color scope + Kelvin-canonical + §3.3 firmware/port-id currency + the §3.7 OccupancySensing row]; AMD-97 device confirmation characterization). Prior regeneration 2026-06-26 Doc 17 Lock (170/50, §50, +1 — AIOT-INV-1; watermark AMD-95); 2026-06-20 Doc 16 Lock (§49, +4 — INV-SA-01..04; watermark stayed AMD-94); 2026-06-19 AMD-94 ratification (165/48); 2026-06-12 (163/47, M7 block); 2026-06-09 (152/41, M6 block). Never propagate a stated total — re-derive from this table._
