...
**Total: 170 invariants across 50 identifier categories (§0.3).** _Regenerated from this table at the 2026-06-26 Doc 17 (AIoT + Cloud Readiness) Lock (§50, +1 — AIOT-INV-1, the sole mint; AIOT-INV-2/3 kept as principles; a new-doc Lock, not an amendment — the watermark is AMD-95 from the same-session AMD-95 currency amendment, which itself minted ZERO invariants); prior regeneration 2026-06-20 Doc 16 (Superior Automation Layer) Lock (§49, +4 — INV-SA-01..04; INV-SA-01/02 novel registered first-class, INV-SA-03/04 citing compositions — watermark stayed AMD-94); 2026-06-19 AMD-94 ratification (165/48, §48, +2 — AMD-94-INV-01/02); 2026-06-12 (163/47, M7 block §42–§47, +11 — AMD-88..93); earlier 2026-06-09 (152/41, M6 block). Never propagate a stated total — re-derive from this table._
